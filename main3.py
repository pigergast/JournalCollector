...
if __name__ == '__main__':
    ...
    pmid_list = CSVFunctions.extract_col_from_csv('Old Code Files/master-list.csv', 1)
    doi_list = CSVFunctions.extract_col_from_csv('Old Code Files/master-list.csv', 2)
    status_list = CSVFunctions.extract_col_from_csv('Old Code Files/master-list.csv', 3)
    pmcid_list = CSVFunctions.extract_col_from_csv('Old Code Files/pmcid-list.csv', 0)
